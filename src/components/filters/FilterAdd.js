...
import { useCreateFilterMutation } from "../../api";
...
import "./filterAdd.scss";

export const FilterAdd = ({firstItem = false, filterAddProps}) => {
    const [ createFilter, { isLoading, isError, error } ] = useCreateFilterMutation();
